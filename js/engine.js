...
var Engine = (function(global) {
    ...
    function checkCollisions() {
        todosInimigos.forEach(function(enemy){
            if(player.x < enemy.x + 60 && player.x + 37 > enemy.x && player.y < enemy.y + 25 && 30 + player.y > enemy.y) {
                player.x = pontoInicio.posicaoJogadorVertical;
                player.y = pontoInicio.posicaoJogadorHorizontal;
     ...
     * de sua array todosInimigos, como definido no app.js, e chama
    ...
    function renderEntities() {
        /* Faça o loop por todos os objetos dentro da array todosInimigos
